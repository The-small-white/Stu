<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Plusbe2019_Admin_AreaManageLight_Edit" %>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" name="theform" id="theform" action="Edit.aspx">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control required" name="SwitchIP" value="<%#news.SwitchIP %>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" class="form-control required" name="SwitchPort" value="<%#news.SwitchPort %>" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">第几路：</label>

                                <div class="col-sm-5">
                                    <input type="number" class="form-control required" name="SwitchIndex" value="<%#news.SwitchIndex %>" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">地址码：</label>

                                <div class="col-sm-5">
                                    <input type="number" class="form-control required" name="SwitchGroup" value="<%#news.SwitchGroup %>" />
                                </div>
                            </div>
