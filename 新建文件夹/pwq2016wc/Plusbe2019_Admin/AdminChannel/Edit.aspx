                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required" data-name="场景名称" name="name" value="<%#news.Name %>"  />
                            </div>
                        </div>
                       <div class="form-group">
                            <label class="col-sm-2 control-label">所属模式：</label>
                            <div class="col-sm-10">
                               
                                 <select class="chosen-select" name="parentID"    id="parentID" style="width:180px;">
                                   <option value="0">做为一级模式</option>
                                     <asp:Repeater ID="repeater" runat="server" DataSource="<%#m_ExhibitionList %>">
                                       <ItemTemplate>
                                     <option  value="<%#((ModeChannel)Container.DataItem).ID %>" <%# SysConfig.Selected(((ModeChannel)Container.DataItem).ID+"",(pid==0?news.ParentID+"":pid+"")) %> <%# ((ModeChannel)Container.DataItem).Child?"":"disabled"%>>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control " data-name="序列"  name="OrderID" value="<%#news.OrderID %>">
