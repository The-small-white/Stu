<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetToIP.aspx.cs" Inherits="Plusbe2019_Admin_TableManage_Edit" %>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="SetToIP.aspx">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                 <select class="chosen-select" name="PCID"    id="PCID" style="width:180px;">
                                     <asp:Repeater ID="repeater" runat="server" DataSource="<%#CloudSQL.GetMyPCList() %>">
                                       <ItemTemplate>
                                       <option  value="<%#((Pclist)Container.DataItem).ID %>" >
                            ...
                            <div class="col-sm-8">
                                 <select class="chosen-select" name="ModeID"    id="ModeID" style="width:180px;">
                                     <asp:Repeater ID="repeater1" runat="server" DataSource="<%#ChannelProvider.SelectAll() %>">
                                       <ItemTemplate>
                                       <option  value="<%#((Channel)Container.DataItem).ID %>"  <%# ((Channel)Container.DataItem).Child?"disabled":""%>>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button class="btn btn-primary" type="button" id="post"><i class="fa fa-check"></i>&nbsp;确认</button>
...
<script>
    $(document).ready(function ()
    {
        ...
        $("#post").click(function ()
        {
            ...
            $.post('SetToIP.aspx', $('#theform').serialize(), function (result) {
                if (!result.isOk)
                {
