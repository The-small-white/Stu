                                 ...
                                 <select class="chosen-select" name="parentID"    id="parentID" style="width:180px;">
                                   <option value="0">做为一级模式</option>
                                     <asp:Repeater ID="repeater" runat="server" DataSource="<%#m_ExhibitionList %>">
                                       <ItemTemplate>
                                     <option  value="<%#((Channel)Container.DataItem).ID %>" <%# SysConfig.Selected(((Channel)Container.DataItem).ID+"",(pid==0?news.ParentID+"":pid+"")) %> <%# ((Channel)Container.DataItem).Child?"":"disabled"%>>
