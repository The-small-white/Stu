            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx">
                        ...
                        <input type="hidden" value="<%#SpeechID %>" name="SpeechID" />
                        <div class="form-group">
                            <label class="col-sm-2 control-label">标题：</label>

                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="title" data-name="标题" value="<%#news.Title %>"  />
                            </div>
                        </div>
                             <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label">命令类型：</label>
                            <div class="col-sm-5">
                      
                               <select class="chosen-select " name="Protocol"    id="Protocol" style="width:180px;" runat="server">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text"  class="form-control required" data-name="IP" name="IP"  value="<%#news.IP %>">
                            </div>
                        </div>
                       <div class="form-group">
                            ...
                            <div class="col-sm-5">
                               <input type="text"  class="form-control required" data-name="端口"  name="Port" value="<%#news.Port %>">
                            </div>
                        </div>
                      <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                  <textarea  name="SendCode"  class="form-control"  aria-required="true"><%#news.SendCode %></textarea>
