                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx" onsubmit="return false;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required"  name="title" id="title" data-name="主机名"  value="<%#news.Title %>"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="ip" data-name="IP"   value="<%#news.IP %>">
