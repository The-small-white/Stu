                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                 <select class="chosen-select" name="UserID"    id="UserID" style="width:180px;">
                                     <option value="0">请选择用户</option>
                                     <asp:Repeater ID="repeater1" runat="server" DataSource="<%#CloudSQL.GetMyUserInfo() %>">
                                       <ItemTemplate>
                                       <option  value="<%#((Userinfo)Container.DataItem).ID %>" <%# SysConfig.Selected(((Userinfo)Container.DataItem).ID+"",news.UserID+"") %> >
                     ...
                     <div class="form-group">
                            <label class="col-sm-2 control-label">蓝牙信标MAC：</label>

                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="BeaconMac" data-name="蓝牙信标MAC" value="<%#news.BeaconMac %>"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">IC卡MAC：</label>

                            <div class="col-sm-5">
                                <input type="text" class="form-control " name="IcMac" data-name="IC卡MAC" value="<%#news.IcMac %>"  />
                            </div>
                        </div>
                        <div class="form-group">
