                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required" data-name="名称" name="name" value="<%#news.Name %>"  />
                            </div>
                        </div>
                       <div class="form-group">
                                 ...
                                 <select class="chosen-select" name="parentID"    id="parentID" style="width:180px;">
                                   <option value="0">做为一级栏目</option>
                                     <asp:Repeater ID="repeater" runat="server" DataSource="<%#m_ExhibitionList %>">
                                       <ItemTemplate>
                                     <option  value="<%#((Exhibition)Container.DataItem).ID %>" <%# SysConfig.Selected(((Exhibition)Container.DataItem).ID+"",news.ParentID+"") %>  <%# ((Exhibition)Container.DataItem).Child?"":"disabled"%>>
