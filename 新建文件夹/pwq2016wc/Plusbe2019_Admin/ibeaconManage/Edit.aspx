                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="DevName" data-name="设备名称" value="<%#news.DevName %>"  />
                            </div>
                        </div>
                      <div class="form-group">
                            <label class="col-sm-2 control-label">设备MAC：</label>

                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="MAC" data-name="设备MAC" value="<%#news.MAC %>"  />
                                 <span class="help-block m-b-none">格式B4E62DBE9A01</span>
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-2 control-label">最大嗅探距离：</label>

                            <div class="col-sm-2">
                                <input type="text" class="form-control required" name="MaxDistance" data-name="最大嗅探距离" value="<%#news.MaxDistance %>"  />
                            </div>
                        </div>
