                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span>
                                <img alt="image" class="img-circle" src="<%=AdminMethod.HeadPic %>" height="64px;" width="64px;" /></span>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a class="J_menuItem" href="CloudNews/manage.aspx?t=-1">我的资源</a>
                                    </li>
                    ...
                    <%if (AdminMethod.CheckManage("niaokan"))
                        { %>
                    <li>
                        <a href="#"><i class="fa fa-niaokan"></i>
                            <span class="nav-label">鸟瞰管理</span>
