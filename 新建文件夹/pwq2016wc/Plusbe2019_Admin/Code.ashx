...
public class Code : IHttpHandler,IRequiresSessionState  {
    ...
    //原始图片所在路径 300*300
    private string path = System.Web.HttpContext.Current.Server.MapPath("Code_src") + "\\300_300\\";
    //原始图片数量
    ...
    //允许误差 单位像素
    private const int _deviationPx = 5;
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (spec)
        {
            ...
            case "300*200":
                ...
                _CutX = 30;
                _CutY = 100;
                path = System.Web.HttpContext.Current.Server.MapPath("Code_src") + "\\300_200\\";
                break;
            case "200*100":
                _ImgWidth = 200;
                _ImgHeight = 100;
                ...
                _CutX = 20;
                _CutY = 50;
                path = System.Web.HttpContext.Current.Server.MapPath("Code_src") + "\\200_100\\";
                break;
        }
        #endregion
        #endregion
    ...
    public void CheckCode(HttpContext context)
    {
        ...
        //{
        //    Write(context, "{\"state\":-1,\"msg\":\"检测到机器人\"}"); return;
        //}
        //校验成功 返回正确坐标
    ...
    public string GetVerificationCode()
    {
        ...
        string Id = (_PositionX.ToString());//X坐标插入数据库(Y坐标给前台)
        HttpContext.Current.Session["PositionX"] = Id;//写到seesion里
    ...
    public static string PositionX
    {
        get
        {
            string _PositionX = Convert.ToString(HttpContext.Current.Session["PositionX"]);
            if (string.IsNullOrEmpty(_PositionX))
            {
                return "";
            }
            else
