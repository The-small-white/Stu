/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/7/16 10:34:26
  Description:    数据表Channel对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与Channel数据表对应对象
    /// </summary>
    public class Channel : IDateBuildTable
    {
        ...
        public Channel(int iD, string name, int typeID, int depth, int parentID, Boolean child, string path, int rootID, string namePath, int vsersion, string pic, string brief, int exhibitionID, int orderID, int addID, DateTime addTime)
        {
        ...
        public bool IsNull
        {
            get
            {
                if (iD_initialized || name_initialized || typeID_initialized || depth_initialized || parentID_initialized || child_initialized || path_initialized || rootID_initialized || namePath_initialized || vsersion_initialized || pic_initialized || brief_initialized || exhibitionID_initialized || orderID_initialized || addID_initialized || addTime_initialized)
                {
                    return false;
                }
                else
