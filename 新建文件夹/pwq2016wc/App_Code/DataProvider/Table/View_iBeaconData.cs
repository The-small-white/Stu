/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/9/4 10:07:31
  Description:    数据表View_iBeaconData对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// <summary>
    /// 与View_iBeaconData数据表对应对象
    /// </summary>
    public class View_iBeaconData : IDateBuildTable
    {
        ...
        public View_iBeaconData()
        {
        }

        public View_iBeaconData(int userID, int iD, int devID, int gateWayID, DateTime lastTime, int stopTime)
        {
        ...
        public bool IsNull
        {
            get
            {
                if (userID_initialized || iD_initialized || devID_initialized || gateWayID_initialized || lastTime_initialized || stopTime_initialized)
                {
                    return false;
                }
                else
        ...
        {
            string tableName = "View_iBeaconData";
            return tableName;
        }
