/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/9/27 10:02:46
  Description:    数据表Device对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与Device数据表对应对象
    /// </summary>
    public class Device : IDateBuildTable
    {
