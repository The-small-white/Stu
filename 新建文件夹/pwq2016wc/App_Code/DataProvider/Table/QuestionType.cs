/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/8/27 11:26:21
  Description:    数据表QuestionType对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// <summary>
    /// 与QuestionType数据表对应对象
    /// </summary>
    public class QuestionType : IDateBuildTable
    {
        ...
        public QuestionType(int iD, int addID, DateTime addTime, string name, int typeID, int depth, int parentID, Boolean child, string path, int rootID, string namePath, int vsersion, string pic, string brief, int exhibitionID, int orderID)
        {
