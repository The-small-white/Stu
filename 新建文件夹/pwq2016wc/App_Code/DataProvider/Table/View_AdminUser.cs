/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/7/17 9:21:40
  Description:    数据表View_AdminUser对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// <summary>
    /// 与View_AdminUser数据表对应对象
    /// </summary>
    public class View_AdminUser : IDateBuildTable
    {
        ...
        public View_AdminUser()
        {
        }

        public View_AdminUser(int iD, int addID, DateTime addTime, string name, string fullName, string pass, int userLevel, int states, string manage, string email, string phone, string jobTitle, int exhibitionID, string address, string sn, string headPic, string brief, DateTime lastLoginTime, string exhibitionName)
        {
        ...
        {
            string tableName = "View_AdminUser";
            return tableName;
        }
