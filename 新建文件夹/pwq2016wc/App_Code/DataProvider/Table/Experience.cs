/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/9/4 10:07:13
  Description:    数据表Experience对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与Experience数据表对应对象
    /// </summary>
    public class Experience : IDateBuildTable
    {
        ...
        private bool jsonData_initialized = false;
        ...
        public Experience(int iD, int userID, DateTime addTime, string brief, string jsonData)
        {
        ...
        public void FromIDataReader(IDataReader dr)
        {
            ...
            if(CheckColumn(dr, "JsonData"))
            {
                if (dr["JsonData"] != null && dr["JsonData"] != DBNull.Value)
                {
                    this.JsonData = Convert.ToString(dr["JsonData"]);
                }
            }
        ...
        public string JsonData
        {
            ...
            set
            {
                jsonData_initialized = true;
                this.m_jsonData = value;
            }
        }
        ...
        public bool IsNull
        {
            get
            {
                if (iD_initialized || userID_initialized || addTime_initialized || brief_initialized || jsonData_initialized)
                {
                    return false;
                }
                else
        ...
        public SqlParameter[] GetSqlParameter(string headStr)
        {
            ...
            if (jsonData_initialized)
            {
                SqlParameter n_Parameter = new SqlParameter("@" + headStr + "JsonData", SqlDbType.NVarChar);
                n_Parameter.Value = this.JsonData;
                n_Parameter.SourceColumn = "JsonData";
                parametersList.Add(n_Parameter);
            }
        ...
        public string UpdateText(string headStr)
        {
            ...
            if(this.m_isAutoUpdate)
            {
                ...
                if (this.jsonData_initialized)
                {
                    contentText += ", [JsonData]=@" + headStr + "JsonData ";
                }
        ...
        public string ConditionText(string headStr)
        {
            ...
            if(this.m_isAutoConditon)
            {
                ...
                if (this.jsonData_initialized)
                {
                    conditionStr += " AND [JsonData]=@" + headStr + "JsonData ";
                }
        ...
        public void AllInitialized()
        {
            ...
            this.jsonData_initialized = true;
        ...
        public void AutoForm(System.Web.UI.Page page)
        {
            ...
            if(page.Request["jsonData"] != null)
            {
                if (this.jsonData_initialized)
                {
                    if(page.Request["jsonData"] != "")
                    {
                        this.JsonData = Convert.ToString(page.Request["jsonData"]);
                    }
                    else
                    {
                        this.jsonData_initialized = false;
                    }
                }
                else
                {
