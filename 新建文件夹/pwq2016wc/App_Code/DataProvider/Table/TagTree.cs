/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/7/17 19:18:17
  Description:    数据表TagTree对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与TagTree数据表对应对象
    /// </summary>
    public class TagTree : IDateBuildTable
    {
        ...
        public TagTree(int iD, string name, int depth, int parentID, Boolean child, string path, int rootID, string namePath, string brief, int addID, DateTime addTime)
        {
