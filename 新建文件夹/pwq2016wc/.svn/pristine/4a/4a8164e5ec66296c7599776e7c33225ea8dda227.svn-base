...
<div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx" onsubmit="return false;">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-sm-5">
                               <textarea  name="Key_Word" class="form-control"  aria-required="true"><%#news.Key_Word %></textarea>
                                <span class="help-block m-b-none">用,（英文输入法）隔开</span>
                            </div>
                        </div>
                            <div class="form-group">
                            <label class="col-sm-2 control-label">备注</label>
                            <div class="col-sm-5">
                               <textarea  name="brief" class="form-control"  aria-required="true"><%#news.Breif %></textarea>
    ...
    <script src="<%=SysConfig.Hui %>js/demo/peity-demo.js"></script>
     ...
     <script src="<%=SysConfig.Hui %>js/form-chosen.js"></script>
<script>
