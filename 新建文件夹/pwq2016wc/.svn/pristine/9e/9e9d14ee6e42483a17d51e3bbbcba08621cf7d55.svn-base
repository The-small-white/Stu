<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Plusbe2019_Admin_TableManageReserveMsg_Edit" %>
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">预约姓名：</label>

                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="ReserveName" data-name="预约人姓名" value="<%#news.ReserveName %>"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input  name="ReservePhone" class="form-control"  value="<%#news.ReservePhone %>"/>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                 <input  name="ReserveTime" class="form-control"  value="<%#news.ReserveTime %>"/>
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                 ...
                                 <select class="chosen-select " name="DateType"    id="DateType" style="width:180px;" >
                                    <asp:Repeater ID="repeater1" runat="server" DataSource="<%#CloudSQL.GetRevDate() %>">
                                       <ItemTemplate>
                                       <option  value="<%#((ReserveDate)Container.DataItem).ID %>" <%# SysConfig.Selected(((ReserveDate)Container.DataItem).ID+"",news.DateType+"") %>>
                                         <%#((ReserveDate)Container.DataItem).Date %>
                                     </option>
                                      </ItemTemplate>
                                       </asp:Repeater>
                                </select>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                 <input  name="ReserveCount" class="form-control"  value="<%#news.ReserveCount %>"/>
