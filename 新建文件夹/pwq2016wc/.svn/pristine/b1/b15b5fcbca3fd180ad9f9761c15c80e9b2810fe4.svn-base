/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/9/16 9:47:55
  Description:    数据表News对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与News数据表对应对象
    /// </summary>
    public class News : IDateBuildTable
    {
        ...
        public News(int iD, int addID, DateTime addTime, string title, string files, string files1, int pcID, string jsonStr, int isjz, int state, long orderID, string picWord, string brief, int fileType, int isPingBao, int exhibitionID, int modeID, string fileSize, int isShare, int isDown, int tagID, int typeID, DateTime shareTime, int oldID, int channelID, string pic, string brief1, string brief2)
        {
