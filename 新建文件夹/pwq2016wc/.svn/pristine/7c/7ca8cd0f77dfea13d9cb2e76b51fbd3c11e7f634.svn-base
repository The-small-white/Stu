/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/7/23 10:53:37
  Description:    数据表View_CloudCount对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// <summary>
    /// 与View_CloudCount数据表对应对象
    /// </summary>
    public class View_CloudCount : IDateBuildTable
    {
        ...
        public View_CloudCount()
        {
        }

        public View_CloudCount(string title, int iD, DateTime addTime, int newsID, int count, string exhibitionName)
        {
        ...
        public bool IsNull
        {
            get
            {
                if (title_initialized || iD_initialized || addTime_initialized || newsID_initialized || count_initialized || exhibitionName_initialized)
                {
                    return false;
                }
                else
        ...
        {
            string tableName = "View_CloudCount";
            return tableName;
        }
