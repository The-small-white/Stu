/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/8/19 16:59:01
  Description:    数据表AgeType对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与AgeType数据表对应对象
    /// </summary>
    public class AgeType : IDateBuildTable
    {
        ...
        public AgeType(int iD, string ageName, int exhibitionID, DateTime addTime, long orderID, string brief, int addID)
        {
        ...
        public bool IsNull
        {
            get
            {
                if (iD_initialized || ageName_initialized || exhibitionID_initialized || addTime_initialized || orderID_initialized || brief_initialized || addID_initialized)
                {
                    return false;
                }
                else
