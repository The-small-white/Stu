/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/7/18 17:40:07
  Description:    数据表IPWhite对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与IPWhite数据表对应对象
    /// </summary>
    public class IPWhite : IDateBuildTable
    {
        ...
        public IPWhite(int iD, string iP, int states, string brief, int addID, DateTime addTime)
        {
        ...
        public bool IsNull
        {
            get
            {
                if (iD_initialized || iP_initialized || states_initialized || brief_initialized || addID_initialized || addTime_initialized)
                {
                    return false;
                }
                else
