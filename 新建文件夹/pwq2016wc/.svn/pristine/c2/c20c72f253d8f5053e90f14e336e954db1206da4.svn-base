/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/12/9 11:21:58
  Description:    数据表Userinfo对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与Userinfo数据表对应对象
    /// </summary>
    public class Userinfo : IDateBuildTable
    {
        ...
        public Userinfo(int iD, string name, string nickName, int gender, string wxID, string phone, DateTime addTime, int ageType, int tradeID, string headImage, DateTime lastModifyTime, string erCode, int addID, int exhibitionID, long orderID, string fileSize, int state)
        {
