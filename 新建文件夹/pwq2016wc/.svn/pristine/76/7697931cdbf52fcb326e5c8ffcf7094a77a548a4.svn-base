...
namespace Dejun.DataProvider.Table
{
    ...
    /// 与Pclist数据表对应对象
    /// </summary>
    public class Pclist : IDateBuildTable
    {
        ...
        public Pclist(int iD, int addID, DateTime addTime, string title, int version, int areaID, int state, string iP, string breif, DateTime lastTime, int exhibitionID)
        {
        ...
        public bool IsNull
        {
            get
            {
                if (iD_initialized || addID_initialized || addTime_initialized || title_initialized || version_initialized || areaID_initialized || state_initialized || iP_initialized || breif_initialized || lastTime_initialized || exhibitionID_initialized)
                {
                    return false;
                }
                else
