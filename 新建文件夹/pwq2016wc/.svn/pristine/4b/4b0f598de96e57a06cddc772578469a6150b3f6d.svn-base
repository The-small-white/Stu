/************************************************************
  ...
  Copyright (c) 2008，
  Author:               Date: 2019/7/26 9:46:27
  Description:    数据表ExhibitionOpen对应的业务逻辑层
  Version:         1.1.0.0
...
namespace Dejun.DataProvider.Table
{
    ...
    /// <summary>
    /// 与ExhibitionOpen数据表对应对象
    /// </summary>
    public class ExhibitionOpen : IDateBuildTable
    {
        ...
        public ExhibitionOpen()
        {
        }

        public ExhibitionOpen(int iD, int exhibitionID, int addID, DateTime addTime)
        {
        ...
        public bool IsNull
        {
            get
            {
                if (iD_initialized || exhibitionID_initialized || addID_initialized || addTime_initialized)
                {
                    return false;
                }
                else
        ...
        {
            string tableName = "ExhibitionOpen";
            return tableName;
        }
