<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Plusbe2019_Admin_TableManageReserveDate_Edit" %>
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal"  name="theform" id="theform" action="Edit.aspx">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="Date" data-name="预约时间段" value="<%#news.Date %>"  />
                                <span class="help-block m-b-none">示例：9:00-11:00</span>
                            </div>
                            
                        </div>
                      <div class="form-group">
                            <label class="col-sm-2 control-label">最大人数限制：</label>

                            <div class="col-sm-5">
                                <input type="text" class="form-control required" name="Count" data-name="最大人数" value="<%#news.Count %>"  />
                            </div>
                        </div>
                        <div class="form-group">
